...
import { Loader } from "./";
import { shortenAddress } from "../utils/shortenAdddress";
const commonStyles =
        ...
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 bg-[#53f0a7] p-3 rounded-full cursor-pointer hover:bg-gradient-to-r from-blue-500 to-blue-700"
            >
